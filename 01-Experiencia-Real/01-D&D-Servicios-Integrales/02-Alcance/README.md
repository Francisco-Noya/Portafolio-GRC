# Alcance — D&D Servicios Integrales de Limpieza

**Clasificación: Experiencia real**

## Alcance definido

El trabajo se centró en el desarrollo de un **programa inicial** de fortalecimiento de la seguridad de la información y la gestión de riesgos, cubriendo:

- Relevamiento del contexto organizacional y tecnológico.
- Identificación de activos de información y operativos relevantes.
- Evaluación de riesgos de seguridad de la información y operacional.
- Priorización de acciones de tratamiento.
- Propuesta inicial de políticas y controles.
